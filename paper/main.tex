...
\begin{tcbexample}{Quantum Solution}{quantum-sol}
  ...
  measurement. Suppose that Alice has observed \(+1\). Notice that
  ...
  \end{equation}
  For the second cell, Alice measures the observable \(Z \otimes I\),
  whose possible outcomes are
    \begin{equation}
    \label{eq:outcomes-1r}
