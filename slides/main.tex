...
\institute[DCC/UFMG]{}
\date{03/07/2023}
\title[Jogos Mágicos]{Jogos Mágicos}
  ...
  \only<2>{
    ...
    \begin{center}
      \begin{tikzpicture}[vertex/.style={circle, thin, fill=blue!30, draw, inner sep=0, minimum size=5pt}]
        ...
        \node [text=red!50!black!80] (label0--2) at ($(01)!0.5!(12) - (0, 0.25)$) {\(-I\)};
        \node [text=green!50!black!80] (label1--4) at ($(01)!0.5!(04) + (-0.3, -0.1)$) {\(+I\)};
        \node [text=green!50!black!80] (label0--3) at ($(04)!0.5!(34) + (-0.1, 0.25)$) {\(+I\)};
        \node [text=green!50!black!80] (label2--4) at ($(23)!0.5!(34) + (+0.1, 0.25)$) {\(+I\)};
        \node [text=green!50!black!80] (label1--3) at ($(12)!0.5!(23) + (+0.3, -0.1)$) {\(+I\)};
...
\begin{frame}{Teorema 3 (Caracterização por Grafo Planar)}
  ...
  \item Propriedade 3: o produto dos observáveis nas arestas ao redor
    ...
    multiplicada pelo signal do vértice
    ...
    \item Se \(M_{1} \ldots M_{n} = I\), com \(M^{2} = I\)
      ...
      \begin{align*}
        M_{k} M_{k + 1} \ldots M_{n} M_{1} M_{k - 1}
...
\begin{frame}{Definição 7 (Menor Topológico)}
